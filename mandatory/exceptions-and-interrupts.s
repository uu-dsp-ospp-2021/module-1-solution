...
# 
# The .globl main assembler directive declares that main is a global 
# symbol that should be visible to code stored in other files.
# 
# The .text assembler directive means that the resulting machine instructions 
# should be placed in the text segment. 
###############################################################################
...
todo_3:
	...
	# TIP 3: Use the ori (bitwise or immediate) instruction and store result in $s0.
