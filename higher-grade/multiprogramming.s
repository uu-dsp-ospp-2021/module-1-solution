...
###############################################################################
# This solution only implements the custom system calls getjid and getc. The 
# Custom system call gets is not yet implementet. 
###############################################################################
...
__trap_handler:
  ...
  # Jump to label __system_call_getc for system call code 12.
   	...
   	li $t1, 12                          # SKIP
   	beq $v0, $t1, __system_call_getc    # SKIP
